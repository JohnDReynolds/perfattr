...
**Archived:** September 9, 2026.

This is the former current-facing performance document preserved intact as audit
history when CLN-007 replaced it with a concise benchmark guide and current snapshot.
The commands, measurements, and release evidence below remain historical facts, not
