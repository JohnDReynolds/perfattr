...
- Treat `_extras/perfattr_roadmap_1.md`, `_extras/perfattr_roadmap_2.md`,
  ...
  `_extras/perfattr_roadmap_6_brinson_hood_beebower_three_effect.md`, and
  `_extras/perfattr_roadmap_7_brinson_hood_beebower_two_effect.md` as completed
  historical context. Their accepted specifications remain the contracts for
  released behavior.
